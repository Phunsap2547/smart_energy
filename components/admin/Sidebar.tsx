...
const navItems = [
  ...
  { label: "Energy Consumption", icon: LineChart, href: "/energy-consumption/page.tsx" },
  { label: "Total Energy", icon: BarChart3, href: "/total-energy/page.tsx" },
  { label: "Status", icon: AlertTriangle, href: "/status/page.tsx" },
];
